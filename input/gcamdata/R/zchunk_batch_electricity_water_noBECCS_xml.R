...
#' module_water_batch_electricity_water_noBECCS_xml
#'
#' Construct XML data structure for \code{electricity_water_noBECCS.xml}.
#'
#' @param command API command to execute
#' @param ... other optional parameters, depending on command
#' @return Depends on \code{command}: either a vector of required inputs,
#' a vector of output names, or (if \code{command} is "MAKE") all
#' the generated outputs: \code{electricity_water_noBECCS.xml}. The corresponding file in the
#' original data system was \code{batch_electricity_water_noBECCS.xml.R} (water XML).
module_water_batch_electricity_water_noBECCS_xml <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    return(c(XML = "electricity_water_noBECCS.xml"))
    ...
    L2233.GlobalTechShrwt_elec_cool <- get_data(all_data, "L2233.GlobalTechShrwt_elec_cool") # MODIFY
    ...
    L2233.GlobalTechShrwt_elecPassthru <- get_data(all_data, "L2233.GlobalTechShrwt_elecPassthru") # MODIFY
    ...
    L2233.StubTechShrwt_elec_cool <- get_data(all_data, "L2233.StubTechShrwt_elec_cool") # MODIFY
    ...
    # Trun off BECCS in electricity generaiton globally
    ## L2233.GlobalTechShrwt_elec_cool_noBECCS
    L2233.GlobalTechShrwt_elec_cool %>%
      filter(!grepl("biomass", technology)) -> L2233.GlobalTechShrwt_elec_cool_NO_biomass

    L2233.GlobalTechShrwt_elec_cool %>%
      filter(grepl("biomass", technology),
             !grepl("CCS", technology)) -> L2233.GlobalTechShrwt_elec_cool_other_biomass

    L2233.GlobalTechShrwt_elec_cool %>%
      filter(grepl("biomass", technology),
             grepl("CCS", technology)) %>%
      # Turn off share-weight
      mutate(share.weight = 0) %>%
      bind_rows(L2233.GlobalTechShrwt_elec_cool_NO_biomass,
                L2233.GlobalTechShrwt_elec_cool_other_biomass)-> L2233.GlobalTechShrwt_elec_cool_noBECCS

    ## L2233.GlobalTechShrwt_elecPassthru_noBECCS
    L2233.GlobalTechShrwt_elecPassthru %>%
      filter(!grepl("biomass", technology)) -> L2233.GlobalTechShrwt_elecPassthru_NO_biomass

    L2233.GlobalTechShrwt_elecPassthru %>%
      filter(grepl("biomass", technology),
             !grepl("CCS", technology)) -> L2233.GlobalTechShrwt_elecPassthru_other_biomass
    ...
    L2233.GlobalTechShrwt_elecPassthru %>%
      ...
      # Turn off share-weight
      mutate(share.weight = 0) %>%
      bind_rows(L2233.GlobalTechShrwt_elecPassthru_NO_biomass,
                L2233.GlobalTechShrwt_elecPassthru_other_biomass)-> L2233.GlobalTechShrwt_elecPassthru_noBECCS

    ## L2233.StubTechShrwt_elec_cool_noBECCS
    L2233.StubTechShrwt_elec_cool %>%
      filter(!grepl("biomass", stub.technology)) -> L2233.StubTechShrwt_elec_cool_NO_biomass

    L2233.StubTechShrwt_elec_cool %>%
      filter(grepl("biomass", stub.technology),
             !grepl("CCS", stub.technology)) -> L2233.StubTechShrwt_elec_cool_other_biomass
    ...
    L2233.StubTechShrwt_elec_cool %>%
      ...
      # Turn off share-weight
      mutate(share.weight = 0) %>%
      bind_rows(L2233.StubTechShrwt_elec_cool_NO_biomass,
                L2233.StubTechShrwt_elec_cool_other_biomass)-> L2233.StubTechShrwt_elec_cool_noBECCS
    ...
    # Produce outputs
    create_xml("electricity_water_noBECCS.xml") %>%
      ...
      add_xml_data(L2233.GlobalTechShrwt_elec_cool_noBECCS, "GlobalTechShrwt") %>%
      ...
      add_xml_data(L2233.GlobalTechShrwt_elecPassthru_noBECCS, "GlobalTechShrwt") %>%
      ...
      add_xml_data(L2233.StubTechShrwt_elec_cool_noBECCS, "StubTechShrwt") %>%
      ...
      add_precursors("L223.Supplysector_elec",
                     ...
                     "L2233.GlobalTechCapital_elec_cool",
                     "L2233.GlobalIntTechCapital_elec_cool") ->
      electricity_water_noBECCS.xml

    return_data(electricity_water_noBECCS.xml)
  } else {
